...
function toggle(action) {
  ...
  var imgProfile = document.getElementsByClassName('imgProfile')[0];
  ...
  window.onload = function () {
    ...
    if (accessToken) {
        // If an access token is found, simulate a login
        handleCredentialResponse({ credential: accessToken });
    } else {
        // If no access token is found, render the Google Sign-In button
